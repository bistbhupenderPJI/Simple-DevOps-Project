...
1. To delete cluster
    ...
    ```
    #need to make sure to delete auto scaling group(it will delete EC2 instance automatically), launch congiuration under (EC2 Auto scaling conguration) and VPC, Route 53 and S3 Buckets
